...
public class DTNHost implements Comparable<DTNHost> {
	 ...
	 * @param conLs Connection listeners
	...
	public DTNHost(List<ConnectionListener> conLs, List<MessageListener> msgLs,
			...
			String groupId,	ModuleCommunicationBus comBus, 
	...
	/**
	 * Return the "current cell" set by the setCurCell method
	 * (for cell based connection checking).
	 ...
	 * @param anotherHost The host to connect to or disconnect from
	 * @param up If true, the a new connection is created, if false, existing
